<template>
    <div>
        ...
        <descripcion-vista
                descripcion="En esta sección puede realizar el ingreso de facturas de sus proveedores"
        ...
        <v-data-table
                ...
                :search=search
                loading-text="Buscando facturas de proveedores"
                dense
        >
            <template v-slot:top>
                <v-col class="py-0" cols="12">
                   <!-- <v-form ref="form_factura_proveedor">
                        <v-row>
                            <v-col
                                    class="py-0"
                                    cols="12"
    ...
    export default {
        ...
        data: () => ({
            ...
            tipoPago:[
                ...
                {id: 6, name: 'Transferencia (Convenio Débito)'},
            ],
            ...
            headers: [
                { text: 'Fecha', value: 'fecha_aut' },
                { text: 'Clave acceso', value: 'clave_acceso', align: 'center', sortable: false },
                { text: 'Pto emisión', value: 'pto_emision' },
                { text: 'Facturero', value: 'facturero' },
